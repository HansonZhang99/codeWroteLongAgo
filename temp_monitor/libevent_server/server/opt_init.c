        ...
        char ca_file[],char crt_file[],char key_file[],int argc,char **argv)
{
    ...
    while((rv=getopt_long(argc,argv,"u:p:t:b:o:i:s:c:r:k:dh",opts,NULL))!=-1)
    {
        ...
        {
            case 'u':
                strncpy(mqtt_username,optarg,ARR_SIZE);
                sum++;
                break;
            case 'p':
                strncpy(mqtt_password,optarg,ARR_SIZE);
                sum++;
                break;
            case 't':
                strncpy(topic,optarg,ARR_SIZE);
                sum++;
                break;
            case 'b':
                strncpy(broker_address,optarg,ARR_SIZE);
                sum++;
                break;
            case 'o':
                *broker_port=atoi(optarg);
                ...
                break;
            case 'i':
                strncpy(server_ip,optarg,ARR_SIZE);
                sum++;
                break;
            case 's':
                *server_port=atoi(optarg);
                ...
                break;
            case 'c':
                strncpy(ca_file,optarg,ARR_SIZE);
                sum++;
                break;
            case 'r':
                strncpy(crt_file,optarg,ARR_SIZE);
                sum++;
                break;
            case 'k':
                strncpy(key_file,optarg,ARR_SIZE);
                sum++;
                break;
            case 'd':
                if(daemon(0,0)<0)
