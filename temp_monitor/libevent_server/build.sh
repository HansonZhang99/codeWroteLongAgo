#!/bin/bash 
#this shell scrpit is used to download and cross compile mosquitto-1.4.9,openssl-1.0.1f,libuuid-1.0.3 and libevent-2.1.10-stable,and install them to the 
